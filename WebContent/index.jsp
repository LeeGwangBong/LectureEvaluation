...
%>						
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			<select name="lectureDivdide" class="form-control mx-1 mt-2" >
...
%>
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					<%= evaluation.getEvaluationTitle() %>&nbsp;<small>(<%= evaluation.getSemesterDivide() %>)</small>
				</h5>
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-group">
							<label>제목</label>
							<input type="text" name="evaluationTitle" class="form-control" maxlength="30"></input>
						</div>
						<div class="form-group">
							<label>내용</label>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="./reportAction.jsp" method="post">
						<div class="form-group">
							<label>신고제목</label>
							<input type="text" name="reportTitle" class="form-control" maxlength="30"></input>
						</div>
						<div class="form-group">
							<label>신고내용</label>
